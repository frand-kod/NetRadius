...
const isEmpty = computed(() =>
    props.segments.length === 0 || props.segments.every((s) => Number(s.value || 0) === 0));
...
<template>
    <div class="flex flex-col items-center gap-3">
        ...
        <div v-else class="flex h-44 items-center justify-center text-sm text-gray-400 dark:text-gray-500">
            Belum ada data
        </div>
    </div>
</template>
