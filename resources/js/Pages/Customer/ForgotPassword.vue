...
<template>
    <GuestLayout>
        <h1 class="mb-4 text-center text-xl font-bold text-gray-900 dark:text-gray-100">Lupa Password</h1>
        ...
        <form @submit.prevent="() => requestForm.post('/customer/forgot-password/request')" class="mb-6 space-y-4">
