...
const form = useForm({
    ...
    price_old: props.plan.price_old,
    type: props.plan.type,
    typebp: props.plan.typebp || '',
    ...
    routers: props.plan.routers,
    is_radius: Boolean(props.plan.is_radius),
    pool: props.plan.pool || '',
    plan_expired: Number(props.plan.plan_expired),
    expired_date: Number(props.plan.expired_date),
    enabled: Boolean(props.plan.enabled),
    allow_purchase: props.plan.allow_purchase,
    prepaid: props.plan.prepaid,
    plan_type: props.plan.plan_type,
    device: props.plan.device,
    on_login: props.plan.on_login || '',
    on_logout: props.plan.on_logout || '',
});
